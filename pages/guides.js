var Guides = {
    template:`
        <div class="container">
            ...
            <figure class="photo-link">
                <figcaption>Resident Evil 8 Village Starting Guide</figcaption>
                <router-link to="/re8">
                    <img src="https://github.com/JustinSingletonDev/singleton_justin_term_project/blob/main/images/re8.jpg?raw=true" alt="Resident Evil 8 title card title card">
                </router-link>
            </figure>
        </div>
    `
